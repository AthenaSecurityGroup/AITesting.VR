//copytoclipboard str BIS_fnc_findSafePos;
//Find safe position.

{
	private _fnc_scriptNameParent = if (isNil '_fnc_scriptName') then {'BIS_fnc_findSafePos'} else {_fnc_scriptName};
	private _fnc_scriptName = 'BIS_fnc_findSafePos';
